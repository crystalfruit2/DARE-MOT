...
class Exp(MyExp):
    def __init__(self):
        ...
        self.val_ann = "train.json"   # all 7 val seqs (multi-seq ablation)       # held-out: uav0000339_00001_v
        ...
        # Standard fine-tuning LR â€” previous 1/10th run produced localization failure
        self.basic_lr_per_img = 0.001 / 64.0

        self.test_conf = 0.001
        self.nmsthre = 0.7

        # 2 workers on Windows (spawn method) â€” 0 caused main-thread hang during mosaic loading
        ...
        # Eval data: held-out pedestrian sequence (val1.json) â€” SAME dir as train (clean split)
